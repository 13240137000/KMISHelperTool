...
namespace KMISHelper.ExcelHelper
{
    class ExcelHelper
    {
        ...
        /// <returns></returns>
        public static DataTable Import(string strFileName,string strSheetName = "")
        {
            ...
            if (string.IsNullOrEmpty(strSheetName.Trim()))
            {
                sheet = (HSSFSheet)hssfworkbook.GetSheetAt(0);
            }
            else
            {
                sheet = (HSSFSheet)hssfworkbook.GetSheet(strSheetName);
            }
        ...
        public static DataTable GetExcelHeader(string strFileName,string strSheetName="")
        {
            DataTable dt = new DataTable();
            ...
            ddr[0] = -1;
            ddr[1] = "---- PLEASE SELECT ONE ----";
            dt.Rows.Add(ddr);

            for (int i = 0; i < headerRow.Cells.Count; i++) {

                var key = i;
                var value = headerRow.Cells[i].StringCellValue.ToString();
